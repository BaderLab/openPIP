...
class AdminSearchController extends Controller
{
	 ...
	 * @Method({"GET", "POST"})
	 */
	public function adminSearchResultsAction($search_term)
	{
	 ...
	 * Search Home
	 *
	 * @Route("admin/search/autocomplete/{search_term}", name="admin_autocomplete_search")
	 * @Method({"GET", "POST"})
	 */
	public function adminAutocompleteAction($search_term)
	{
