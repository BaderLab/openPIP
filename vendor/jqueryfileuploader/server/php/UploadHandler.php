...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
    	...
    	$this->options = array(
    		...
    		'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../../../web/uploads/' . $upload_directory . "/" ,
    		'upload_url' => $this->get_full_url().'/../../../../../web/uploads/' . $upload_directory . "/",
